...
gio_tieu_chuan = 44  #số h làm chuẩn mỗi tuần
gio_vuot_chuan = max(0, so_gio_lam - gio_tieu_chuan) # số h làm vượt chuẩn mỗi tuần 
thuc_linh = gio_tieu_chuan * luong_gio + gio_vuot_chuan * luong_gio * 1.5  #tính tổng thu nhập
print(f"Số tiền thực lĩnh của NV: {thuc_linh} đồng.")